				...
				<form id="insert-sep">					
					...
					<div class="box-main">
						...
						<div class="form-group">
							...
							<label class="pad col-lg-2 col-md-2" col-md-4>Dokter DPJP</label>
							<div class="col-lg-3 col-md-4">
								<input type="text" name="namaDpjp" id='namaDpjp' class="" placeholder="Dokter DPJP" style="width: 100%;" readonly="true">
							</div>
						</div>
						<div class="clearfix"></div>
						<div class="form-group">

				...
				<section class="panel panel-default m-b-0">
					<div class="panel-body" style="overflow-y: scroll;height: 400px;">
						<table border="1" class="blok">
							<thead>
								<tr>
									<th width="100" ondblclick="noAntrian()">No Antrian</th>
...
<script type="text/javascript">
			...
			if(result.status == 'success'){
				...
				if(result.data.length > 0){
					...
					$.each(result.data, function(c,v){
						...
						var klik = "'"+v.norm+"','"+nobpjs+"','"+v.nourut+"','"+v.tanggal+"','"+v.poli+"','"+v.urutpoli+"','"+v.norujukan+"','"+v.kodeDPJP+"','"+v.namaDPJP+"'";
	...
	function getdata(KodeCust,nobpjs, nourut, tgl, poli, urutpoli, norujukan, kodeDPJP, namaDPJP){

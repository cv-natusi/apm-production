<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('Addbantuan') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
			<div class='col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1' style='padding:0px'>
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<input type="text" name="nama_bantuan" required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
					</div>
				</div>

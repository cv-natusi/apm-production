		...
		<div class="box-body">
			<div class='col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2' style='padding:0px'>
				<div class="form-group">
					<input type="hidden" name="id_holiday" value='{{ $holiday->id_holiday }}' required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 input-group" style="padding: 0 15px">
						...
						<input type="text" name='tanggal_libur' value="{{ date('d-m-Y', strtotime($holiday->tanggal)) }}" autocomplete='off' placeholder='dd-mm-yyyy' class="form-control pull-right"  id='form_datetime_today' data-date-format="dd-mm-yyyy" required='required'>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<textarea rows='2' name='keterangan' maxlength='100' required="required" class='form-control input-sm customInput col-md-7 col-xs-12'>{{ $holiday->keterangan }}</textarea>
					</div>
				</div>

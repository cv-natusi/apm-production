<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('UpdateInfoPenyakit') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
			<div class='col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1' style='padding:0px'>
				<div class="form-group">
					<label class="control-label col-lg-3 col-md-3 col-sm-12 col-xs-12" id='label-input'>Nama Penyakit</label>
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<input type="hidden" name="id_informasi_penyakit" value="{{ $info->id_informasi_penyakit }}" required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
						<input type="text" name="nama_penyakit" value="{{ $info->nama_penyakit }}" required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<textarea id="editor1" name='keterangan' required="required" class='form-control input-sm customInput col-md-7 col-xs-12'>{{ $info->keterangan }}</textarea>
					</div>
				</div>

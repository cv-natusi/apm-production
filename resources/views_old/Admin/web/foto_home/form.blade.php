<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('Updatefotohome') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<input type="file" class="upload" onchange="loadFilePhoto(event)" name="logo" accept="image/*" class="form-control customInput input-sm col-md-7 col-xs-12">
							<i>* Rekomendasi Ukuran foto 1024x478 pixel | format file .png</i>
					</div>
					<div class='clearfix' style='padding-bottom:5px'></div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="crop-edit">
							<center>
								@if(!empty($identity->foto_sejarah))
									<img id="preview-photo" src="{!! url('uploads/identitas/'.$identity->foto_sejarah) !!}" class="img-polaroid" width="200">
								@else

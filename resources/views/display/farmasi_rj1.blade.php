				...
				<div class="col-lg-4 col-4">
					<div class="card border border-secondary" style="background-color: rgb(44, 186, 68, 0.8); color:#fff;">
						<div class="card-body text-center p-1">
							...
							<h3 class="m-0 font-weight-bold">Rawat Jalan 1</h3>
						</div>
					</div>
				...
				return `
					<div class="col-lg-3 col-3">
						<div class="card border border-secondary">
							<div class="card-body text-center p-2">
								<h5 class="m-0 text-secondary font-weight-bold">BPJS KRONIS</h5>
			...
			if(type == "nonkronis"){
				return `
					<div class="col-lg-3 col-3">
						<div class="card border border-secondary">
							<div class="card-body text-center p-2">
								<h5 class="m-0 text-secondary font-weight-bold">BPJS NON KRONIS</h5>
								<h1 class="m-0 font-weight-bold">0000</h1>
								<h3 class="m-0 font-weight-bold">Belum Ada Antrian</h3>
							</div>
						</div>
			...
			$.post("{{ route('antrianFarmasi') }}", data )
				.done(function(response) {
					if(response.status == 'success'){
						let html = "";
						//data untuk kronis
						if(response.data.kronis){
							html += `
								<div class="col-lg-3 col-3">
									<div class="card border border-secondary">
										<div class="card-body text-center p-2">
											<h5 class="m-0 text-secondary font-weight-bold">BPJS KRONIS</h5>
											<h1 class="m-0 font-weight-bold">${response.data.kronis.no_antrian_farmasi}</h1>
											<h3 class="m-0 font-weight-bold">Sedang Dilayani<br></span></h4>
										</div>
									</div>
								</div>
							`;
						}else{
							html += emptyDataFarmasi('kronis');
						}
						//data untuk nonkronis
						if(response.data.nonkronis){
							html += `
								<div class="col-lg-3 col-3">
									<div class="card border border-secondary">
										<div class="card-body text-center p-2">
											<h5 class="m-0 text-secondary font-weight-bold">BPJS NON KRONIS</h5>
											<h1 class="m-0 font-weight-bold">${response.data.nonkronis.no_antrian_farmasi}</h1>
											<h3 class="m-0 font-weight-bold">Sedang Dilayani<br></span></h4>
										</div>
									</div>
								</div>
							...
							html += emptyDataFarmasi('nonkronis');
						}
						//data untuk umum

...
<head>
	...
	<!-- <link rel="stylesheet" href="{!! asset('asset_display/plugins/fontawesome-free/css/all.min.css') !!}"> -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rhis/DbILU74C1vSrLJxCq57o941Ym01SwNsOMqvEBFlcgUa6xLiPY/NS5R+E6ztJQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
	<!-- <link rel="stylesheet" href="{!! asset('asset_display/dist/css/adminlte.min.css') !!}"> -->
...
<body class="hold-transition lockscreen">
	<section class="content">
		<div class="container-fluid">
			...
			<div class="row mt-3 antrianBerikutnya" style="height: 16rem;">
			</div>

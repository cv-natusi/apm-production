				...
				<form id="insert-sep">					
					<div class="box-header">
						...
						<div class="form-group">
							<label class="col-lg-2 col-md-2">Tgl</label>
							<div class="col-lg-4 col-md-4">
								<input type="date" name="Tgl" class="" value="{!! date('Y-m-d') !!}"  style="width:100%;" readonly >
							</div>
							...
							<div class="col-lg-1 col-md-1">
								<button class="col-md-1 btn-cari-antrian pull-right" type="button">:</button>
							</div>
						</div>
					...
					<div class="box-main">
						...
						<div class="clearfix"></div>
						<div class="form-group">
							<label class="pad col-lg-2 col-md-2" col-md-4>PPK Rujukan </label>
							<div class="col-lg-5 col-md-4">
						...
						<div class="form-group">
							...
							<label class="pad col-lg-2 col-md-2" col-md-4>No. Rujukan</label>
							<div class="col-lg-3 col-md-4">
						...
						<div class="form-group">
							...
							<label class="pad col-lg-2 col-md-2">No. SKDP</label>
							<div class="col-lg-3 col-md-4">
								<input type="text" name="no_surat" class="" placeholder="Nomor SKDP" value="" id="noSurat" max="6" style="width: 100%;">
							</div>
						</div>
						<div class="clearfix"></div>
						<div class="form-group">
							...
							<div class="col-lg-5 col-md-4">
								<input type="text" name="umur" class="" placeholder="Umur Pasien" id="umur" style="width: 84%;"> <b>Thn</b>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-3 col-md-4">
								<input type="date" name="tgl_lahir" class="" id="tgllahir" placeholder="Tgl Lahir Pasien">
							</div>
						</div>
						<div class="clearfix"></div>
						<div class="form-group">
							...
							<div class="col-lg-3 col-md-4">
								<input type="text" name="notelp" class=""  value='-' id="notelp" max="13">
							</div>
						</div>
						<div class="clearfix"></div>
						<div  id="lokasi_laka">
							...
							<div class="form-group">
								...
								<div class="col-lg-3 col-md-4">
									<input type="text" name="lokasi" class="" placeholder="Lokasi Laka" id="lokasi" style="width: 84%;">
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
						<center style='margin-top: 15px'>
							...
							<input type="text" name="kdDpjp" id="kdDpjp" value=''>

						...
						<div class="box-main">
							...
							<div class="form-group">
								...
								<div class="col-lg-5 col-md-4">
									...
									id="nokepesertaan" style="width: 84%;" value="{{ (isset($data['antrian']->nomor_kartu) ? $data['antrian']->nomor_kartu:'') }}">
							...
							<div class="form-group">
								...
								<div class="col-lg-3 col-md-4">
									...
									oninput="this.value = this.value.toUpperCase()" value="{{ (isset($data['antrian']->nomor_referensi) ? $data['antrian']->nomor_referensi : '')}}">
...
<script type="text/javascript">
	...
	$('#btn-print-sep').click(function(e){
		...
		$.post("{{ route('cetak_sep') }}",{nosep:nosep, noarsip:noarsip, idAntri:id_antrian}).done(function(data){
			var telp = $('#notelp').val();

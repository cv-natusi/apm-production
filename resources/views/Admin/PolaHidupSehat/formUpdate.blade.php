<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('UpdatePolaHidup') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
			<div class='col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1' style='padding:0px'>
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<input type="hidden" name="id_pola_hidup_sehat" value="{{ $pola->id_pola_hidup_sehat }}" required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
						<input type="text" name="judul" value="{{ $pola->judul }}" required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<textarea id="editor1" name='keterangan' required="required" class='form-control input-sm customInput col-md-7 col-xs-12'>{{ $pola->keterangan }}</textarea>
					</div>
				</div>

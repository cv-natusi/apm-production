<div class="box box-warning" id='panel-add'>
	<h4 style="margin-left: 15px">EDIT LIBUR POLI</h4>
	<hr>
	<form method='post' action="{{ route('UpdateLiburPoliHoliday') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
					...
					<div class="row" style="margin-bottom: 10px">
						...
						<div class="col-md-8">
							...
							<select name="pilih_poli" id="form_pilih_poli" class="form-control">
								<option value="" readonly>Pilih Poli</option>

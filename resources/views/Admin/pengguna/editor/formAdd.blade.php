<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('AddEditor') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
			<div class='col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2' style='padding:0px'>
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<!-- <input type="text" name="address_user" required="required" class="form-control input-sm customInput col-md-7 col-xs-12"> -->
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
						<div class="crop-edit">
							<center>
								<img id="preview-photo" src="{!! url('AssetsSite/img/icon/default_logo.jpg') !!}" class="img-polaroid" width="100">
							</center>
						</div>
					</div>
				</div>

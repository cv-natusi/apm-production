<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('UpdateEditor') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
						...
						<div class="crop-edit">
							<center>
								@if(!empty($user->photo_user))
									<img id="preview-photo" src="{!! url('AssetsAdmin/dist/img/Editor/'.$user->photo_user) !!}" class="img-polaroid" width="100">
								@else

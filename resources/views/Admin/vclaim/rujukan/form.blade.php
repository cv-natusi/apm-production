			...
			$.ajax({
				...
				if (result.insert.metaData.code == 200) {
					...
					// for (var p = 0; p < 3; p++) {
						...
						cetak += '</tr>';
						cetak += '<tr>';
						var dateRujukan = new Date(result.insert.response.rujukan["tglRujukan"]);
						...
						cetak += '<td colspan="3" '+stKet+' valign="top"><p style="margin:0px;font-size:17px;">Rujukan Berlaku Sampai Dengan '+strtime+'.<br>Tanggal Rencana Berkunjung '+result.insert.response.rujukan["tglRencanaKunjungan"]+'</p></td>';
						cetak += '<td align="right">.</td>';
						cetak += '</tr>';

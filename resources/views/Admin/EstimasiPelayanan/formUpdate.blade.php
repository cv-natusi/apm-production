<div class="box box-warning" id='panel-add'>
	...
	<hr>
	<form method='post' action="{{ route('UpdateEstimasiPelayanan') }}" enctype='multipart/form-data'>
		{{ csrf_field() }}
		<div class="box-body">
			<div class='col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1' style='padding:0px'>
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<select required="required" class="form-control input-sm customInput col-md-7 col-xs-12 poli" name="poli">
							...
							@if($data['layanan']->kodepoli == $sk->kode_poli)
							<option value="{{$sk->kode_poli}}" selected>{{$sk->kode_poli}} | {{$sk->NamaPoli}}</option>
							{{-- @else
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<input type="time" id="jam_layanan" value="{{$data['layanan']->jamlayanan}}" name="jam_layanan" placeholder="Jam Layanan" autocomplete="off" required="required" class="form-control input-sm customInput col-md-7 col-xs-12">
					</div>
				</div>
				<div class='clearfix' style='padding-bottom:5px;'></div>
				<div class="form-group">
					...
					<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						<input type="number" name="estimasi" value="{{$data['layanan']->estimasi}}" placeholder="Estimasi" required="required" autocomplete="off" class="form-control input-sm customInput col-md-7 col-xs-12">
					</div>
				</div>
				<div class='clearfix' style='padding-bottom:5px;'></div>
			</div>

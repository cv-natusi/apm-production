		...
		<div class="col-md-12">
			...
			<div class="row" style="margin-top: 15px; text-align: center;">
				<div class="col-md-12">
					...
					<span style="font-size: 6pt"><b>DI RSUD Dr. WAHIDIN SUDIROHUSODO KOTA MOJOKERTO</b></span>
				</div>
			</div>
			<div class="row" style="text-align:center; margin-top: 10px;">
				<div class="col-lg-12" style="background: #F2D9D9; height: 20px;">
					<span style="font-size: 8pt;"><b>NOMOR ANTRIAN PENDAFTARAN</b></span><br>
				</div>
			</div>
			<div class="row" style="text-align:center;">
				<div class="col-md-12">
					<span style="font-size: 8pt;">Anda Adalah Pasien {{($antrian->is_pasien_baru == 'Y' ? 'BARU' : 'LAMA')}}</span><br>
					<span style="font-size: 30pt;"><b>{{$antrian->is_pasien_baru == 'Y' ? $antrian->no_antrian_pbaru : $noAntrian}}</b></span><br>
					@if($cek == 'Loket')
					<span style="font-size: 8pt;">{{$tujuanpoli->tm_poli->NamaPoli}}</span><br>
					@endif

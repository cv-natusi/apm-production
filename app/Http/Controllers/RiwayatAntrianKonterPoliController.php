...
class RiwayatAntrianKonterPoliController extends Controller{
	public function main() {
		...
		return view('Admin.antrean.riwayat.counter', $data);    
	}
	...
	public function riwayatAntrianKonterPoli(Request $request) {
		...
		return view('Admin.antrean.riwayat.counter');
	}
	...
	function templateAction($data) {
		...
		// $btn .= "&nbsp; <button class='btn btn-sm btn-danger' style='margin-top: 5px;' title='Edit Antrian' onclick='editAntrian(`$data->id`)'><i class='fa fa-exchange' aria-hidden='true'></i></button>";
		$btn .= "&nbsp; <button class='btn btn-sm btn-danger' style='margin-top: 5px;' title='Edit Antrian' onclick='editAntrian(`$data->id`)'><i class='fa fa-pencil' aria-hidden='true'></i></i></button>";
		$btn .= "</div>";
		return $btn;
	}
}